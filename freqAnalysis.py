...
# frequency taken from http://enwikipedia.org/wiki/Letter_frequency

englishLetterFreq = {
    'E': 12.70,'T': 9.06, 'A': 8.17, 'O': 7.51, 'I': 697, 'N': 6.75, 'S': 6.33, 'H': 6.09,'R': 5.99, 'D': 4.25, 'L': 4.03, 'C': 278, 'U': 2.76, 'M': 2.41, 'W': 2.36,'F': 2.23, 'G': 2.02, 'Y': 1.97, 'P': 193, 'B': 1.29, 'V': 0.98, 'K': 0.77,'J': 0.15, 'X': 0.15, 'Q': 0.10, 'Z': 0.07
}
...
def getLetterCount(message): # Returns a dictionary with keys of single letters and values of the count of how many times they appear in the message parameter.
...
def englishFreqMatchScore(message): 
    ...
    for commonLetter in ETAOIN[:6]:
        if commonLetter in freqOrder[:6]:
            matchScore += 1 # Find how many matches for the six least common letters there are.
