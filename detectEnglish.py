...
# (There must be a "dictionary.txt" file in this directory with all English words in it, one word per line. You can download this from "http://invpy.com/dictionary.txt")
